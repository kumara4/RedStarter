                            ...
                            <div className="row">
                                <div>New Password:
                                    <input id="newpw" type="password" placeholder="New Password"
                                           pattern="[a-z]{1,15}"
                                           title="Password should only contain 6-10 characters;
                                                may contain upper and lower case and digits 0-9."/>

                                    <button type="button" className="btn btn-default btn-sm " id="help"
                                            data-help="Password should only contain 6-10 characters; may contain upper and lower case and digits 0-9.">
